...
Revision ID: 4f71a2ca7e9c
Revises:
Create Date: 2024-07-16 16:26:34.968169
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_user_organization_created_at"),
        "user_organization",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_user_organization_updated_at"),
        "user_organization",
        ["updated_at"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_user_organization_updated_at"), table_name="user_organization"
    )
    op.drop_index(
        op.f("ix_user_organization_created_at"), table_name="user_organization"
    )
