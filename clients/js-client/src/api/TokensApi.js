...
export default class TokensApi {
  ...
  createApiTokenTokensPost(aPITokenCreate, opts, callback) {
    ...
    if (aPITokenCreate === undefined || aPITokenCreate === null) {
      throw new Error(
        "Missing the required parameter 'aPITokenCreate' when calling createApiTokenTokensPost",
      );
    }
  ...
  deleteApiTokenTokensTokenIdDelete(tokenId, opts, callback) {
    ...
    if (tokenId === undefined || tokenId === null) {
      throw new Error(
        "Missing the required parameter 'tokenId' when calling deleteApiTokenTokensTokenIdDelete",
      );
    }
