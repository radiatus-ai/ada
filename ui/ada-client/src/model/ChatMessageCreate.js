...
class ChatMessageCreate {
    ...
    constructor(role, content, model, tokens, contentRaw, chatId) {
        ...
        ChatMessageCreate.initialize(this, role, content, model, tokens, contentRaw, chatId);
    }
...
ChatMessageCreate.RequiredProperties = ["role", "content", "model", "tokens", "content_raw", "chat_id"];
