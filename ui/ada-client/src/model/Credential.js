...
class Credential {
     ...
     */
    constructor(name, credentialType, id, organizationId) {

        Credential.initialize(this, name, credentialType, id, organizationId);
    }
     ...
     */
    static initialize(obj, name, credentialType, id, organizationId) {
        obj['name'] = name;
...
Credential.RequiredProperties = ["name", "credential_type", "id", "organization_id"];
 ...
 */
Credential.prototype['metadata'] = undefined;
