...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlatformApi.ChatMessageCreate();
  });
  ...
  describe('ChatMessageCreate', function() {
    it('should create an instance of ChatMessageCreate', function() {
      // uncomment below and update the code to test ChatMessageCreate
      //var instance = new PlatformApi.ChatMessageCreate();
      //expect(instance).to.be.a(PlatformApi.ChatMessageCreate);
    });
