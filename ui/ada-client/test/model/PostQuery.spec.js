...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlatformApi.PostQuery();
  });
  ...
  describe('PostQuery', function() {
    it('should create an instance of PostQuery', function() {
      // uncomment below and update the code to test PostQuery
      //var instance = new PlatformApi.PostQuery();
      //expect(instance).to.be.a(PlatformApi.PostQuery);
    });
